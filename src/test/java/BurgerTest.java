...
public class BurgerTest {
    ...
    public void getReceiptTest() {
        float mockPrice = 2;
        float mockPrice2 = 5;
        String mockBunName = "Цветная булочка";
        String mockIngredientName = "Барбекю";
        String mockIngredientSecondName = "Астория";
        IngredientType sauce = IngredientType.SAUCE;
        String expectedReceiptString = "(==== Цветная булочка ====)\r\n" +
                "= sauce Барбекю =\r\n" +
                "= sauce Астория =\r\n" +
                "(==== Цветная булочка ====)\r\n" +
                "\r\n" +
